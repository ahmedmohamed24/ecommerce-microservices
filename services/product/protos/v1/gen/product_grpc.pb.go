...
const (
	...
	ProductService_UpdateProductQuantity_FullMethodName = "/proto_product_v1.ProductService/UpdateProductQuantity"
)
...
func (c *productServiceClient) UpdateProductQuantity(ctx context.Context, in *UpdateProductQuantityRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ProductService_UpdateProductQuantity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) UpdateProductQuantity(context.Context, *UpdateProductQuantityRequest) (*emptypb.Empty, error) {
